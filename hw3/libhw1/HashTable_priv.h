...
/// Helper method that takes in a LinkedList and a key to search
// and returns true if the key exists in the list
//
// bucket: LinkedList to search
// key: key value use to search for element in the list
// keyvalue: the return varible that stores the old key value if found
// remove: an identifier for determining whether the keyvalue is removed or not
bool Bucket_Lookup(LinkedList *bucket, HTKey_t key,
